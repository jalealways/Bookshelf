    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_pic', models.CharField(blank=True, db_column='COVER_PIC', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            name='TbReaderInfo',
            fields=[
                ('wechat_id', models.CharField(db_column='WECHAT_ID', max_length=64, primary_key=True, serialize=False)),
                ('tel_no', models.CharField(blank=True, db_column='TEL_NO', max_length=11, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('shelf', models.ForeignKey(db_column='SHELF_ID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='weixin.TbBookshelfBaseInfo')),
                ('box_id', models.CharField(db_column='BOX_ID', max_length=100)),
                ('book_id', models.CharField(blank=True, db_column='BOOK_ID', max_length=10, null=True)),
                ('box_status', models.CharField(blank=True, db_column='BOX_STATUS', max_length=1, null=True)),
                ('order_reader_id', models.CharField(blank=True, db_column='ORDER_READER_ID', max_length=10, null=True)),
                ('update_time', models.DateTimeField(blank=True, db_column='UPDATE_TIME', null=True)),
